...
rooms={
    ...
    "tings":"门厅地毯下的纸条:⼀张陈旧的纸条，似乎是从某本书⻚上撕下来的，上⾯潦草地\
    写着 ‘光芒指引⽅向’。",
    "way":["north","east"]},
    "Grand Hall":{
    ...
    "Hallway":{
    "description":"你沿着昏暗的⾛廊前⾏，脚踩在吱吱作响的⽊地板上。墙壁上挂着褪⾊的家族画像，画\
    像中的⼈物表情模糊不清，仿佛在注视着你。⾛廊尽头似乎传来微弱的滴⽔声。⻄⾯是⻔\
    厅。",
    ...
    "things":"壁炉旁的⽕柴:⼀盒潮湿的⽕柴，看起来还能⽤，也许可以点燃什么。\
    ⽔槽边的⽔桶:⼀个破旧的⽊⽔桶，⾥⾯积满了浑浊的⾬⽔。",
    "way":["south","down"]
    }
}
